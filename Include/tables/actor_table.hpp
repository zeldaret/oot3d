 ...
 */
/* 0x0000 */ DEFINE_ACTOR(Player, ACTOR_PLAYER, ALLOCTYPE_NORMAL)
...
/* 0x0009 */ DEFINE_ACTOR(En_Door, ACTOR_EN_DOOR, ALLOCTYPE_NORMAL)
...
/* 0x0010 */ DEFINE_ACTOR(En_Bom, ACTOR_EN_BOM, ALLOCTYPE_NORMAL)
...
/* 0x0015 */ DEFINE_ACTOR(En_Item00, ACTOR_EN_ITEM00, ALLOCTYPE_NORMAL)
/* 0x0016 */ DEFINE_ACTOR(En_Arrow, ACTOR_EN_ARROW, ALLOCTYPE_NORMAL)
...
/* 0x0023 */ DEFINE_ACTOR(En_Holl, ACTOR_EN_HOLL, ALLOCTYPE_NORMAL)
...
/* 0x002E */ DEFINE_ACTOR(Door_Shutter, ACTOR_DOOR_SHUTTER, ALLOCTYPE_NORMAL)
...
/* 0x0032 */ DEFINE_ACTOR(En_Boom, ACTOR_EN_BOOM, ALLOCTYPE_NORMAL)
...
/* 0x0039 */ DEFINE_ACTOR(En_A_Obj, ACTOR_EN_A_OBJ, ALLOCTYPE_NORMAL)
...
/* 0x0056 */ DEFINE_ACTOR(En_M_Fire1, ACTOR_EN_M_FIRE1, ALLOCTYPE_NORMAL)
/* 0x0057 */ DEFINE_ACTOR(En_M_Thunder, ACTOR_EN_M_THUNDER, ALLOCTYPE_NORMAL)
...
/* 0x0066 */ DEFINE_ACTOR(Arms_Hook, ACTOR_ARMS_HOOK, ALLOCTYPE_NORMAL)
...
/* 0x009E */ DEFINE_ACTOR(Magic_Wind, ACTOR_MAGIC_WIND, ALLOCTYPE_NORMAL)
/* 0x009F */ DEFINE_ACTOR(Magic_Fire, ACTOR_MAGIC_FIRE, ALLOCTYPE_NORMAL)
...
/* 0x00F4 */ DEFINE_ACTOR(Magic_Dark, ACTOR_MAGIC_DARK, ALLOCTYPE_NORMAL)
...
/* 0x010A */ DEFINE_ACTOR(Arrow_Fire, ACTOR_ARROW_FIRE, ALLOCTYPE_NORMAL)
/* 0x010B */ DEFINE_ACTOR(Arrow_Ice, ACTOR_ARROW_ICE, ALLOCTYPE_NORMAL)
/* 0x010C */ DEFINE_ACTOR(Arrow_Light, ACTOR_ARROW_LIGHT, ALLOCTYPE_NORMAL)
...
/* 0x017E */ DEFINE_ACTOR(Oceff_Spot, ACTOR_OCEFF_SPOT, ALLOCTYPE_NORMAL)
...
/* 0x018A */ DEFINE_ACTOR(Oceff_Wipe, ACTOR_OCEFF_WIPE, ALLOCTYPE_NORMAL)
/* 0x018B */ DEFINE_ACTOR(Oceff_Storm, ACTOR_OCEFF_STORM, ALLOCTYPE_NORMAL)
...
/* 0x0198 */ DEFINE_ACTOR(Oceff_Wipe2, ACTOR_OCEFF_WIPE2, ALLOCTYPE_NORMAL)
/* 0x0199 */ DEFINE_ACTOR(Oceff_Wipe3, ACTOR_OCEFF_WIPE3, ALLOCTYPE_NORMAL)
...
/* 0x01CB */ DEFINE_ACTOR(Oceff_Wipe4, ACTOR_OCEFF_WIPE4, ALLOCTYPE_NORMAL)
...
/* 0x01D7 */ DEFINE_ACTOR(Actor_1D7, ACTOR_1D7, ALLOCTYPE_NORMAL)
/* 0x01D8 */ DEFINE_ACTOR(Actor_1D8, ACTOR_1D8, ALLOCTYPE_NORMAL)
/* 0x01D9 */ DEFINE_ACTOR(Actor_1D9, ACTOR_1D9, ALLOCTYPE_NORMAL)
/* 0x01DA */ DEFINE_ACTOR(Actor_1DA, ACTOR_1DA, ALLOCTYPE_NORMAL)
