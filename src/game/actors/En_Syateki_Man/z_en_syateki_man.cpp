...
GLOBAL_ASM("asm/EnSyatekiMan_BlinkWait.s")
...
GLOBAL_ASM("asm/EnSyatekiMan_Idle.s")

GLOBAL_ASM("asm/EnSyatekiMan_RestartGame.s")

GLOBAL_ASM("asm/EnSyatekiMan_SetupIdle.s")

GLOBAL_ASM("asm/EnSyatekiMan_Start.s")

GLOBAL_ASM("asm/EnSyatekiMan_StartGame.s")

GLOBAL_ASM("asm/EnSyatekiMan_StopTalk.s")

GLOBAL_ASM("asm/EnSyatekiMan_Talk.s")

GLOBAL_ASM("asm/EnSyatekiMan_WaitForGame.s")
