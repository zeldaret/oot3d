...
GLOBAL_ASM("asm/EnOkuta_Appear.s")

GLOBAL_ASM("asm/EnOkuta_Die.s")

GLOBAL_ASM("asm/EnOkuta_Freeze.s")

GLOBAL_ASM("asm/EnOkuta_Hide.s")

GLOBAL_ASM("asm/EnOkuta_OverrideLimbDraw.s")

GLOBAL_ASM("asm/EnOkuta_ProjectileFly.s")

GLOBAL_ASM("asm/EnOkuta_SetupShoot.s")

GLOBAL_ASM("asm/EnOkuta_SetupWaitToAppear.s")

GLOBAL_ASM("asm/EnOkuta_Shoot.s")

GLOBAL_ASM("asm/EnOkuta_WaitForShoot.s")
