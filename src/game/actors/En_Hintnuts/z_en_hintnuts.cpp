...
GLOBAL_ASM("asm/EnHintnuts_BeginFreeze.s")

GLOBAL_ASM("asm/EnHintnuts_BeginRun.s")

GLOBAL_ASM("asm/EnHintnuts_Burrow.s")

GLOBAL_ASM("asm/EnHintnuts_Freeze.s")

GLOBAL_ASM("asm/EnHintnuts_Leave.s")

GLOBAL_ASM("asm/EnHintnuts_LookAround.s")

GLOBAL_ASM("asm/EnHintnuts_OverrideLimbDraw.s")

GLOBAL_ASM("asm/EnHintnuts_PostLimbDraw.s")

GLOBAL_ASM("asm/EnHintnuts_Run.s")

GLOBAL_ASM("asm/EnHintnuts_Stand.s")

GLOBAL_ASM("asm/EnHintnuts_Talk.s")

GLOBAL_ASM("asm/EnHintnuts_ThrowNut.s")
