...
GLOBAL_ASM("asm/EnDaiku_Change.s")

GLOBAL_ASM("asm/EnDaiku_EscapeRotate.s")

GLOBAL_ASM("asm/EnDaiku_EscapeRun.s")

GLOBAL_ASM("asm/EnDaiku_EscapeSuccess.s")

GLOBAL_ASM("asm/EnDaiku_InitEscape.s")

GLOBAL_ASM("asm/EnDaiku_Jailed.s")

GLOBAL_ASM("asm/EnDaiku_OverrideLimbDraw.s")

GLOBAL_ASM("asm/EnDaiku_PostLimbDraw.s")

GLOBAL_ASM("asm/EnDaiku_TentIdle.s")

GLOBAL_ASM("asm/EnDaiku_UpdateText.s")
